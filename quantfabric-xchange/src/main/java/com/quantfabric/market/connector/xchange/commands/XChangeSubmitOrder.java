...
public abstract class XChangeSubmitOrder implements ConcreteCommand, SubmitOrder {
	
	private final static Logger log = LoggerFactory.getLogger(XChangeSubmitOrder.class);
	private TradeOrder order;

	public XChangeSubmitOrder(TradeOrder order) {
	...
	public void execute(CommandExecutor commandExecuter) {
		...
		try {
			...
			LimitOrder limitOrder = createOrder();
	...
	protected abstract LimitOrder createOrder() throws Exception;
