...
public abstract class CompletionStrategyOrderExecutionReport extends
		StrategyOrderExecutionReport
{
	private long ackRoundTrip;
	
	public CompletionStrategyOrderExecutionReport()
	{
		super();
	}
	
	public CompletionStrategyOrderExecutionReport(String orderReference,
	...
	public void setAckRoundTrip(long ackRoundTrip)
	{
	...
	{
		return super.toString() + " ackRoundTrip=" + ackRoundTrip + ";";
	}
