...
public class ManageStrategyOrderSoftFillCommand extends ManageStrategyOrderCommand
{
	private String fillExecutionId;

	public ManageStrategyOrderSoftFillCommand()
	{
		super();
		setFillExecutionId(null);
	}

	public ManageStrategyOrderSoftFillCommand(String originalOrderReference,
