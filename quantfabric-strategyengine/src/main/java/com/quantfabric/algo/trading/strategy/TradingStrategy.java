...
public interface TradingStrategy extends StrategyDefinition, Startable, StrategyRuntime, ManualTradingProvider
{
	ExecutionProvider getExecutionProvider();	
	void setLayoutDefinitionProvider(LayoutDefinitionProvider layoutDefinitionProvider);
	void destroyCep();
}
