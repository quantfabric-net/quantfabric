 ...
 */
package com.quantfabric.algo.market.gateway.access;
...
{
	Set<Product> getProductList() throws Exception;
	SubscriptionResult subscribe(String productCode, ContentType contentType, 
			SubscriptionOptions subscriptionOption) throws Exception;
}
