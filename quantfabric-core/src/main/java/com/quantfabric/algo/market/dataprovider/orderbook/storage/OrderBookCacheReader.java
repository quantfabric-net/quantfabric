...
public interface OrderBookCacheReader extends OrderBookInfo
{	
	void addOrderBookSnapshotListener(OrderBookSnapshotListener listener);
	OrderBookSnapshotListener removeOrderBookSnapshotListener(String name);
