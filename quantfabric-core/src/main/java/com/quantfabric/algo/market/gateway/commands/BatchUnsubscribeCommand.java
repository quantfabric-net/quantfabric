...
public class BatchUnsubscribeCommand implements Command, Subscribe {
    private Collection<MarketDataFeed> mdFeeds;

    private Collection<ExecutionFeed> exFeeds;

    public BatchUnsubscribeCommand(Collection<MarketDataFeed> mdFeeds,Collection<ExecutionFeed> exFeeds) {
