...
public  class MarketConnectionException extends Exception
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5456068178299694981L;
	...
	public MarketConnectionException(String message, Throwable cause)
	{
		super(message, cause);
	}
	...
	public MarketConnectionException(Throwable cause)
	{
		super(cause);
	}		
}