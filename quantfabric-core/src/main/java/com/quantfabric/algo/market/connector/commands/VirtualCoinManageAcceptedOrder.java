...
public abstract class VirtualCoinManageAcceptedOrder implements ManageAcceptedOrder, ConcreteCommand{

	private TradeOrder order;
	private String institutionOrderReference;
	
	public VirtualCoinManageAcceptedOrder(TradeOrder order) {
		
		this(order, null);
	}
	
	public VirtualCoinManageAcceptedOrder(TradeOrder order, String institutionOrderReference) {
		setOrder(order);
