...
public class Filled extends Trade 
{
	private static final long serialVersionUID = 7427981520854544168L;
	...
	public Filled(long timestamp, long messageId, String sourceName,
	...
	public Filled(long messageId, String sourceName, Date sourceTimestamp,
                  String institutionOrderReference, String localOrderReference,
                  String executionID, long price, double quantity)
	{
		super(messageId, sourceName, sourceTimestamp, institutionOrderReference,
				localOrderReference, executionID, price, quantity);
	}

	public Filled(long messageId, String sourceName, long sourceTimestamp,
			String institutionOrderReference, String localOrderReference,
