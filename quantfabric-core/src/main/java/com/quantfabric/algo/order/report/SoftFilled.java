...
public class SoftFilled extends Trade
{	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3089628933932548318L;
	...
	public SoftFilled(long timestamp, long messageId, String sourceName,
	...
	public SoftFilled(long messageId, String sourceName, Date sourceTimestamp,
	...
	public SoftFilled(long messageId, String sourceName, long sourceTimestamp,
			String institutionOrderReference, String localOrderReference,
			String executionID, int price, double quantity)
	{
		super(messageId, sourceName, sourceTimestamp, institutionOrderReference,
	...
	{
		return OrderStatus.ConfirmFillPending;
	}
}
