...
public class Canceled extends Interrupted
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 7504727576947467020L;
	...
	public Canceled(long timestamp, long messageId, String sourceName,
	...
	public Canceled(long messageId, String sourceName,
			Date sourceTimestamp, String institutionOrderReference,
			String localOrderReference, String executionID)
	{
	...
	public ExecutionReportType getExecutionReportType()
	{
		...
		return ExecutionReportType.Canceled;
	}
