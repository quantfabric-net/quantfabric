...
public class PendingCancel extends Interrupted {

    private static final long serialVersionUID = 7504727576947467021L; //generate another

    public PendingCancel(long messageId, String sourceName,
