...
import com.quantfabric.algo.backtesting.BackTestingCommandFactory;
import com.quantfabric.algo.commands.ConcreteCommand;
import com.quantfabric.algo.order.TradeOrder;


public class VirtualCoinBackTestingCommandFactory extends BackTestingCommandFactory {
	@Override
	
	public ConcreteCommand createSubmitOrder(TradeOrder order)
			throws CommandFactoryException
	{
		return new VirtualCoinBackTestingSubmitOrderCommand(order);
	}
}
