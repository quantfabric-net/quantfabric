...
{
	private static final long serialVersionUID = 2175351631659167706L;

	private final String instrumentId;
		
	public SimpleDescription(String instrumentId)
	{
		super();
	...
	{
		return "Description [instrumentId=" + instrumentId + "]";
	}
}
