...
{
	void processNewSnapshot(OrderBookSnapshot orderBookSnapshot) 
		throws OrderBookSnapshotListenerException;
	void processEndUpdate(OrderBookInfo orderBookInfo, long updateId, boolean isBookModified);
	void processNoUpdate(long snapshotId);
}
