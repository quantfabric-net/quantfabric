...
public interface MarketViewAggregator extends OrderBookSnapshotListener, MarketDataProcessor
{	
	Properties getProperties();
	
	void subscribe(MarketViewAggregatorListener subscriber);
	void unSubscribe(MarketViewAggregatorListener subscriber);
}
