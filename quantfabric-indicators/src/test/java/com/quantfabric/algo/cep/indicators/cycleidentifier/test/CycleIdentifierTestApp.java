 ...
 */
package com.quantfabric.algo.cep.indicators.cycleidentifier.test;
...
import com.quantfabric.algo.cep.indicators.cycleidentifier.CycleIdentifierPluginView;
import com.quantfabric.algo.cep.indicators.cycleidentifier.CycleIdentifierPluginViewFactory;
...
public class CycleIdentifierTestApp {
	...
	{
		configuration.addPlugInView("quantfabric", "ci", CycleIdentifierPluginViewFactory.class.getName());		
	}
	...
	private static void registerTestStatements(EPAdministrator epAdministrator)
	{
		...
		epAdministrator.createEPL("select * from Bars(closed=true).quantfabric:ci(4, 4, barId, close, high, low, closed)").addListener(
			new UpdateListener() 
			{				
				@Override
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		CycleIdentifierPluginView.getLogger().setLevel(Level.ALL);
